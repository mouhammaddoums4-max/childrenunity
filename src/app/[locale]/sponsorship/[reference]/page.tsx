      ...
      <div className="mt-8 grid gap-8 sm:gap-10 lg:grid-cols-[1.25fr_1fr] lg:gap-14">
        ...
        <div>
          <div className="flex flex-wrap items-baseline gap-x-4 gap-y-2">
            <h1 className="font-display text-h1 font-extrabold text-navy">
              {child.firstName}
            </h1>
          ...
          <div
            className={`mt-8 aspect-[16/9] overflow-hidden rounded-card ${accent.softBg}`}
          >
            {photo ? (
              <Image
                src={photo}
        ...
        <aside className="lg:sticky lg:top-24 lg:self-start">
          <div className="rounded-card border border-line bg-white p-6 sm:p-7">
            ...
            >
              <div
                className={`reveal-bar h-full rounded-full ${accent.bar}`}
